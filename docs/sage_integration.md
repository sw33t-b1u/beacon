...
- `pir_output.json` has been generated by BEACON (`uv run python -m cmd.generate_pir`)
...
After regenerating, always validate with `cmd.validate_pir` before deploying to SAGE.
