...
Organization: manufacturing | Japan, Southeast Asia
...
2 PIR(s) generated (P1/P2 threshold met). This plan covers supplemental collection activities.
...
2 PIR(s) generated — active collection required.
...
APT1, APT12, APT16, APT17, APT18, APT19, APT28, APT29, APT3, APT30, APT37, APT41, APT5, Andariel, Aoqin Dragon, AppleJeus, BRONZE BUTLER, BlackTech, Cinnamon Tempest, Contagious Interview, Daggerfly, Darkhotel, DragonOK, Dragonfly, Earth Lusca, Elderwood, Ember Bear, FIN13, FIN7, GALLIUM, GCMAN, Gamaredon Group, Gelsemium, HAFNIUM, Higaisa, Inception, IndigoZebra, Indrik Spider, Ke3chang, Kimsuky, Lazarus Group, Leviathan, Lotus Blossom, MirrorFace, Mofang, Mustang Panda, Naikon, Night Dragon, Nomadic Octopus, Putter Panda, Rancor, Salt Typhoon, Sandworm Team, Scarlet Mimic, Star Blizzard, Suckfly, TA459, TA505, TA577, Threat Group-3390, Tonto Team, Tropic Trooper, Turla, UNC3886, Volt Typhoon, Winter Vivern, Wizard Spider, ZIRCONIUM, admin@338, menuPass
...
- ICS-CERT / JPCERT OT 脆弱性情報・ICS 脅威インテリジェンス・IT-OT 横断攻撃事例
...
| OT/ICS 脆弱性情報確認 | 週次 | OT セキュリティ担当 |
| APTグループ TTP 更新確認 (APT1, APT12, APT16) | 月次 | CTIチーム |
